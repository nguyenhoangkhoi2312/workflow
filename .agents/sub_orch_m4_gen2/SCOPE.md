...
- Backend routes:
  ...
  - `POST /api/documents/{document_id}/invite` and `/api/documents/{document_id}/members`
...
- `POST /api/documents/{document_id}/invite` and `/api/documents/{document_id}/members` -> invite and query members for a standalone document context

  ...
  return (
    <div style={{ backgroundColor: '#FAFAF9', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{ display: 'flex', justifyContent: 'space-between', padding: '24px 48px', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '16px' }}>
          <button 
            ...
            style={{ 
              padding: '10px 24px', borderRadius: '24px', backgroundColor: 'white', color: '#1B2A4E', 
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 24px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '3.5rem', fontWeight: 900, color: '#1B2A4E', marginBottom: '16px', maxWidth: '800px', lineHeight: 1.2 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px', marginTop: '64px', maxWidth: '1000px', width: '100%' }}>
          <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '16px', border: '1px solid var(--border-light)', boxShadow: 'var(--shadow-sm)', textAlign: 'left' }}>
            <div style={{ color: 'var(--brand-primary)', fontWeight: 900, fontSize: '1.5rem', marginBottom: '8px' }}>01</div>
            <div style={{ fontWeight: 700, color: '#1B2A4E', marginBottom: '8px' }}>AI LỘ TRÌNH</div>
          ...
          <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '16px', border: '1px solid var(--border-light)', boxShadow: 'var(--shadow-sm)', textAlign: 'left' }}>
            ...
            <div style={{ fontWeight: 700, color: '#1B2A4E', marginBottom: '8px' }}>TÀI LIỆU AI</div>
          ...
          <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '16px', border: '1px solid var(--border-light)', boxShadow: 'var(--shadow-sm)', textAlign: 'left' }}>
            ...
            <div style={{ fontWeight: 700, color: '#1B2A4E', marginBottom: '8px' }}>SMART REMINDER</div>
          ...
          <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '16px', border: '1px solid var(--border-light)', boxShadow: 'var(--shadow-sm)', textAlign: 'left' }}>
            ...
            <div style={{ fontWeight: 700, color: '#1B2A4E', marginBottom: '8px' }}>CHAT THÔNG MINH</div>
